...
def qtest():
  ...
  qtest_ans = input("")
  qtest_ans = qtest_ans.lower()
  if qtest_ans == "1" or "hello":
      print("correct")
  else:
   print("incorrect")
...
def q3():
    ...
    if q3_ans == "1" or q3_ans == "blue": 
      ...
      print("incorrect")
      q3()
  #Ask the user what the color green is in Te Reo. If they say 1 or kakariki. Then write correct. If they type anything else... then write incorrect and make them redo the quiz.
def q4():
...
def q5():
    ...
    if q5_ans == "1" or "welcome":
      ...
      print("incorrect")
      q5()
  #Ask the user How to say how are you in Te Reo. If they say  1 or Kei te pehea koe. Then write correct. But if they say anything else. Then write incorrect.
def q6():
    ...
    if q6_ans == "1" or q6_ans == "kei te pehea koe":
      ...
      print("incorrect")
      q6()
  #Ask the user how do you say new zealand in te reo. If they type 1 or aotearoa. Then write correct. But if they write anything else. Then write incorrect. 
def q7():
    ...
    if q7_ans == "1" or q7_ans == "Aotearoa":
      ...
      print("incorrect")
      q9()
  #Ask the user What is the most famous greeting in te reo that is widely used across new zealand. If tghey type 1 or kia ora. Then write correct. If they write anything else. Then write incorrect. 
def q8():
    ...
    if q8_ans == "1" or q8_ans == "Kia Ora":
      ...
      print("incorrect")
      q8()
  #Ask the user what does ata marie mean? if they type 1 or kia ora, then write correct. If they write anything else. Then write incorrect
def q9():
    ...
    if q9_ans == "1" or "kia ora":
      ...
      print("incorrect")
      q9()
  #Ask the user what does Nga mihi mean? If they write 1 or congratulations. Then write correct. If they type anything else. Then write incorrect. 
def q10():
